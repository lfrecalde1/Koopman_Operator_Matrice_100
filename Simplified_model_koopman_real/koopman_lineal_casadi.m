...
subplot(3,1,2)
plot(salida_real(8,1:length(X2)),'-','Color',[226,76,44]/255,'linewidth',1); hold on
plot(v_estimate(8,1:length(X2)),'--','Color',[100,76,10]/255,'linewidth',1); hold on
grid on;
...
subplot(3,1,3)
plot(salida_real(9,1:length(X2)),'-','Color',[226,76,44]/255,'linewidth',1); hold on
plot(v_estimate(9,1:length(X2)),'--','Color',[100,76,10]/255,'linewidth',1); hold on
grid on;
