function [A_final, B_final, G_final] = funcion_costo_koopman_csadi(X_1, X_K, U, alpha, beta, n, m, n_normal)
...
for k = 1:length(U)
    ...
    error_koop = Gamma_k  -A*Gamma_1 - B*U(:,k) -G;
    
    error_prediction = x_k - C_a*(A*Gamma_1 + B*U(:, k) + G) ;
    %% Error Vector
