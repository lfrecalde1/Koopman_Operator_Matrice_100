...
grid on;
plot(t(1:length(ul_ref)),hd(1, 1:length(t)),'--','Color',[226,76,44]/255,'linewidth',1); hold on
legend({'$x$', '$x_d$'},'Interpreter','latex','FontSize',11,'Orientation','horizontal');
legend('boxoff')
title('$\textrm{Identification signals and real Signals}$','Interpreter','latex','FontSize',9);
...
grid on;
plot(t(1:length(ul_ref)),hd(2, 1:length(t)),'--','Color',[46,188,89]/255,'linewidth',1); hold on
legend({'$y$', '$y_d$'},'Interpreter','latex','FontSize',11,'Orientation','horizontal');
legend('boxoff')
ylabel('$[m]$','Interpreter','latex','FontSize',9);
xlim([0 t(end)])
...
grid on;
plot(t(1:length(ul_ref)),hd(3, 1:length(t)),'--','Color',[26,115,160]/255,'linewidth',1); hold on
legend({'$z$','$z_d$'},'Interpreter','latex','FontSize',11,'Orientation','horizontal');
legend('boxoff')
ylabel('$[m]$','Interpreter','latex','FontSize',9);
xlim([0 t(end)])
...
grid on;
plot(t(1:length(ul_ref)),hd(4, 1:length(t)),'--','Color',[26,115,160]/255,'linewidth',1); hold on
legend({'$\psi$','$\psi_d$'},'Interpreter','latex','FontSize',11,'Orientation','horizontal');
legend('boxoff')
