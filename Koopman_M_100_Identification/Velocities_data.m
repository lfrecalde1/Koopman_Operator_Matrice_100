...
switch n    
    ...
    case 12
        close all
%         ul_ref = [0*ones(1, 50), 1*ones(1,150), 0*ones(1,150) -1*ones(1, 151)];
%         um_ref = [0*ones(1, 50), -2*ones(1,150), -0*ones(1,150) 2*ones(1, 151)];
%         un_ref = [0*ones(1, 50), -0.5*ones(1,150), 0.5*ones(1,150) 0*ones(1, 151)];
%         w_ref = [0*ones(1, 50), -0.3*ones(1,100), -0*ones(1,100) 0.3*ones(1, 100), -0.1*ones(1,100),  0.1*ones(1, 51),];
        ul_ref=2.5*cos(t).*sin(0.5*t)+0.3*cos(0.7*t).*cos(0.3*t);
        um_ref=0*sin(t).*sin(0.5*t)+0*cos(0.7*t).*cos(0.3*t);
        un_ref = 2.5*cos(t).*sin(0.5*t)+0.3*cos(0.7*t).*cos(0.3*t);
        w_ref = 0.0*sin(t).*sin(0.5*t)+0.0*cos(0.7*t).*cos(0.3*t);
        subplot(4,1,1)
        plot(ul_ref);
        subplot(4,1,2)
        plot(um_ref);
