...
grid on;
plot(vd_world(1,1:length(t)),'--','Color',[50,100,10]/255,'linewidth',1); hold on
...
plot(vd_world(2,1:length(t)),'--','Color',[50,100,10]/255,'linewidth',1); hold on
...
plot(vd_world(3,1:length(t)),'--','Color',[50,100,10]/255,'linewidth',1); hold on
